...
import { ConnectionStatus } from "@/types/google-workspace";
...
export function GoogleStatusBadge({ status, className = "" }: GoogleStatusBadgeProps) {
  const styles: Record<ConnectionStatus, { bg: string; text: string; dot: string; label: string }> = {
    connected: {
