...
<style>
        ...
        ::-webkit-scrollbar-thumb { background: #bbcbb9; border-radius: 10px; }
...
<div class="w-10 h-10 rounded-lg flex items-center justify-center"><img alt="ExpendMore Logo" class="w-full h-full object-contain" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCTZCz8S-cy00FSMBmorkK5N6C738EOsawOjKFS77jRQY37EAkhrNcvvtq3ba4F5601zAUf3_2hhbkwNP8uUPO_AlBXhzITL_R5vkJepmcIzI-4mdh541_ubp3bTbGkXemEOA4H3zrQhXTy3B0bHM-VbwX3HzhiRRBl36uEOlKKNGoZa97LgQMEJkMu6FJnus7Q5KvfQVDn4cuyhL4qd4X2AUB7w0HNp6Li97HLXQZHxX37n8q7_OYEdoyGLcO_clq4"/></div>
<div>
<h1 class="text-headline-md font-headline-md text-on-surface leading-tight">ExpendMore</h1>
<p class="text-label-sm font-label-sm text-on-surface-variant">Marketing API</p>
</div>
</div>
<nav class="flex-1 space-y-2">
<a class="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant hover:bg-surface-variant/50 transition-all duration-300" href="../expendmore_dashboard_light/code.php">
<span class="material-symbols-outlined">dashboard</span>
<span class="font-medium">Dashboard</span>
</a>
<a class="flex items-center gap-md px-md py-sm rounded-lg bg-primary-container text-on-primary border-r-4 border-on-primary/30 translate-x-1 transition-transform" href="../expendmore_campaign_manager_light/code.php">
<span class="material-symbols-outlined">campaign</span>
<span class="font-medium">Campaigns</span>
</a>
<a class="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant hover:bg-surface-variant/50 transition-all duration-300" href="../expendmore_buy_growth_coins_light/code.php">
...
<a class="flex items-center gap-md px-md py-sm text-label-sm font-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">
...
<div class="flex items-center gap-md">
<div class="hidden sm:flex items-center gap-xs text-primary bg-primary-container/10 px-md py-xs rounded-full border border-primary-container/20">
<span class="material-symbols-outlined text-[18px]">payments</span>
<span class="text-label-sm font-bold">Balance: 1,250</span>
</div>
<button class="text-on-surface-variant hover:text-primary transition-colors scale-95 active:scale-90 flex items-center gap-xs">
<span class="material-symbols-outlined">notifications</span>
</button>
<button class="text-on-surface-variant hover:text-primary transition-colors scale-95 active:scale-90">
<span class="material-symbols-outlined">settings</span>
</button>
...
<div>
<h2 class="text-headline-lg font-headline-lg text-on-surface leading-tight">Create Campaign</h2>
<p class="text-on-surface-variant">Automate your business communication in minutes.</p>
</div>
</div>
<div class="glass-panel p-md lg:p-lg rounded-xl shadow-sm relative overflow-hidden">
<!-- Atmospheric effect -->
...
<input class="w-full bg-surface-container-low border border-outline-variant rounded-lg p-md text-on-surface placeholder:text-on-surface-variant/50 focus:border-primary transition-all" placeholder="e.g., Summer Expansion 2024" type="text"/>
</div>
...
<div class="relative">
<select class="w-full bg-surface-container-low border border-outline-variant rounded-lg p-md text-on-surface appearance-none focus:border-primary transition-all">
...
<div class="p-md border border-outline-variant rounded-lg flex items-center justify-center gap-sm bg-surface-container-low peer-checked:border-primary peer-checked:bg-primary-container/10 transition-all">
<span class="material-symbols-outlined text-primary">send</span>
<span class="text-label-sm font-bold text-on-surface">Send Now</span>
</div>
</label>
<label class="flex-1 cursor-pointer">
...
<span class="text-label-sm font-bold text-on-surface">Schedule</span>
</div>
</label>
</div>
</div>
<div class="pt-md">
<button class="w-full py-md rounded-xl whatsapp-gradient text-on-primary font-bold text-lg shadow-md hover:brightness-105 transition-all active:scale-95 flex items-center justify-center gap-md" type="submit">
                                    Launch Campaign
...
<div class="flex items-center justify-between">
<h3 class="text-headline-md font-headline-md text-on-surface">Recent Campaigns</h3>
<a class="text-label-sm text-primary hover:underline transition-all" href="#">View All</a>
</div>
<div class="space-y-md">
<!-- Campaign Item 1 -->
<div class="glass-panel p-md rounded-xl hover:border-primary transition-colors group">
<div class="flex justify-between items-start mb-sm">
<div class="flex items-center gap-sm">
<div class="w-10 h-10 rounded-lg bg-surface-container-high flex items-center justify-center">
<span class="material-symbols-outlined text-primary" style="font-variation-settings: 'FILL' 1;">done_all</span>
</div>
<div>
...
<span class="bg-primary/10 text-primary text-label-xs px-sm py-xs rounded-full font-bold uppercase">Sent</span>
</div>
...
<!-- Campaign Item 2 -->
<div class="glass-panel p-md rounded-xl hover:border-on-surface-variant transition-colors group">
<div class="flex justify-between items-start mb-sm">
<div class="flex items-center gap-sm">
<div class="w-10 h-10 rounded-lg bg-surface-container-high flex items-center justify-center">
<span class="material-symbols-outlined text-on-surface-variant" style="font-variation-settings: 'FILL' 1;">pending</span>
</div>
<div>
...
<span class="bg-surface-container-high text-on-surface-variant text-label-xs px-sm py-xs rounded-full font-bold uppercase">Pending</span>
</div>
<div class="w-full h-1 bg-surface-container-high rounded-full overflow-hidden">
<div class="w-1/2 h-full bg-on-surface-variant"></div>
</div>
</div>
<!-- Campaign Item 3 -->
...
<!-- Visual Ad Card -->
<div class="relative h-48 rounded-xl overflow-hidden group cursor-pointer border border-outline-variant">
...
<h5 class="text-white font-bold">Scaling Internationally?</h5>
<p class="text-label-sm text-white/80 mb-sm">Get 20% off Coin packs this month.</p>
<button class="text-label-sm font-bold text-primary-fixed hover:text-primary-fixed-dim transition-colors flex items-center gap-xs">
...
<a class="text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">Terms</a>
<a class="text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">Privacy</a>
<a class="text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">API Docs</a>
<a class="text-label-sm text-on-surface-variant hover:text-primary transition-colors" href="#">Status</a>
</div>
</footer>
</main>
...
<a class="flex flex-col items-center text-primary" href="../expendmore_campaign_manager_light/code.php">
...
<a class="flex flex-col items-center text-on-surface-variant hover:text-primary" href="../expendmore_buy_growth_coins_light/code.php">
...
<script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const notifyIcon = Array.from(document.querySelectorAll('button .material-symbols-outlined')).find(el => el.textContent.trim() === 'notifications');
            if(notifyIcon) {
                const notifyBtn = notifyIcon.closest('button');
