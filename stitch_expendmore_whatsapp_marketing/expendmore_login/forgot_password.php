            ...
            if (check_login_lockout($emailInput)) {
                ...
                try {
                    ...
                    if ($user && $user['status'] === 'active') {
                        ...
                        Mailer::getInstance()->sendPasswordReset($emailInput, $user['full_name'] ?: 'User', $token, false);
...
<body class="overflow-x-hidden min-h-screen flex flex-col justify-between hero-gradient">
    ...
    <nav class="flex justify-between items-center w-full px-margin-desktop h-16 bg-background/80 backdrop-blur-xl border-b border-outline-variant">
        ...
        <div class="flex items-center gap-md">
            <a href="../expendmore_login_light/forgot_password.php" class="text-on-surface-variant hover:text-primary transition-colors flex items-center gap-xs text-label-sm font-label-sm">
                ...
                <form action="forgot_password.php" method="POST" class="space-y-md">
                    ...
                    <div class="space-y-xs">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" required placeholder="name@company.com" class="w-full bg-[#1A1A1A] border border-[#2A2A2A] rounded-lg py-3 pl-10 pr-4 text-on-surface placeholder:text-on-surface-variant/40 focus:outline-none transition-all">
                        </div>
                    </div>
